...
class Stochastic(object):
    def __init__(self, centers, villages, nb_scena):
        ...
        # Cunsomption constat
        self._scena = np.arange(1,nb_scena+1)
        self._beta = {}
    ...
    def create_constraints(self):
        ...
        for s in self._scena:
            for k in self.drone:
                self._model +=  pulp.lpSum(self._beta[s,i,j] * self.center.get_distance_from_village(i,j) * 
    ...
    def get_solution(self):
        ...
        """
        sol = Solution('Stochastic', self.center, self.village)
